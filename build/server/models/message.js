...
var CONCURRENT_DESTROY, CONSTANTS, ImapPool, LIMIT_DESTROY, LIMIT_UPDATE, MSGBYPAGE, Mailbox, Message, NotFound, _, americano, async, htmlToText, log, mailutils, uuid,
...
Message.prototype.imap_applyChanges = function(newflags, flagsOps, newmailboxIDs, boxOps, callback) {
  ...
  return Mailbox.getBoxes(this.accountID, (function(_this) {
    return function(err, boxes) {
      var box, boxIndex, boxid, firstboxid, firstuid, j, k, len, len1, ref, uid;
      if (err) {
        return callback(err);
      }
      boxIndex = {};
        ...
        return async.series([
          function(cb) {
            ...
            return imap.multicopy(firstuid, paths, function(err, uids) {
              ...
              for (i = l = 0, ref1 = uids.length - 1; l <= ref1; i = l += 1) {
...
Message.findConversationID = function(mail, callback) {
  var isReplyOrForward, key, keys, ref, references;
