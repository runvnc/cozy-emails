...
var Imap, ImapImpossible, MailParser, _old1, async, folderDuplicate, folderForbidden, folderUndeletable, log, mailutils, stream_to_buffer_array;
...
Imap.prototype.openBoxCheap = function(name, callback) {
  var ref;
  if (((ref = this._box) != null ? ref.name : void 0) === name) {
